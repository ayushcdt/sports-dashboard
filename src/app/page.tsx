...
import { useTodayEvents } from '@/hooks/use-events';
...
export default function HomePage() {
  ...
  const {
    ...
    lastUpdated,
    isFetching,
  } = useTodayEvents(selectedSport === 'all' ? undefined : selectedSport);
      ...
      <div className="space-y-6">
        <div>
          ...
          <p className="text-muted-foreground">
            Live matches and today&apos;s schedule
          </p>
        </div>
        <QueryError
          error={error}
      ...
      <EventsGrid
        ...
        emptyMessage={
          selectedSport === 'all'
            ...
            : `No ${selectedSport} events scheduled for today`
        }
      />
    </div>
  );
